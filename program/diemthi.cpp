...
void hienThiChiTietBaiThi(ChiTietBaiThi* danhSach) {
    ...
    cout << "╔══════════════════════════════════════════════════════════════════════════════════════╗" << endl;
    cout << "║                            CHI TIẾT BÀI THI                                          ║" << endl;
    cout << "╠══════════════════════════════════════════════════════════════════════════════════════╣" << endl;
    cout << "║ ID Câu Hỏi │ Đáp Án Chọn │ Kết Quả                                                 ║" << endl;
    cout << "╠════════════╪═════════════╪════════════════════════════════════════════════════════════╣" << endl;
    
    ChiTietBaiThi* temp = danhSach;
    while (temp != nullptr) {
        cout << "║ " << setw(10) << temp->idCauHoi << " │ " << setw(11) << temp->dapAnChon 
             << " │ " << setw(54) << (temp->dung ? "Đúng" : "Sai") << " ║" << endl;
        temp = temp->tiep;
    }
    cout << "╚════════════╧═════════════╧════════════════════════════════════════════════════════════╝" << endl;
}
...
void hienThiDanhSachDiem(DiemThi* danhSach) {
    ...
    cout << "╔══════════════════════════════════════════════════════════════════════════════════════╗" << endl;
    cout << "║                            DANH SÁCH ĐIỂM THI                                        ║" << endl;
    cout << "╠══════════════════════════════════════════════════════════════════════════════════════╣" << endl;
    cout << "║ Mã Môn │ Điểm │ Ngày Thi                                                            ║" << endl;
    cout << "╠════════╪══════╪═════════════════════════════════════════════════════════════════════╣" << endl;
    
    DiemThi* temp = danhSach;
    while (temp != nullptr) {
        cout << "║ " << setw(6) << temp->maMon << " │ " << setw(4) << fixed << setprecision(1) 
             << temp->diem << " │ " << setw(67) << temp->ngayThi << " ║" << endl;
        temp = temp->tiep;
    }
    cout << "╚════════╧══════╧═════════════════════════════════════════════════════════════════════╝" << endl;
}
...
void luuKetQuaThi(SinhVien* sv, const string& maMon, ChiTietBaiThi* chiTiet) {
    ...
    cout << "Đã lưu kết quả thi. Điểm của bạn: " << fixed << setprecision(1) << diem << endl;
}
...
void xemChiTietBaiThi(SinhVien* sv, const string& maMon) {
    ...
    cout << "╔══════════════════════════════════════════════════════════════════════════════════════╗" << endl;
    cout << "║                            KẾT QUẢ THI CHI TIẾT                                      ║" << endl;
    cout << "╠══════════════════════════════════════════════════════════════════════════════════════╣" << endl;
    cout << "║ Mã môn: " << setw(15) << maMon << " │ Điểm: " << setw(10) << fixed 
         << setprecision(1) << diemThi->diem << " │ Ngày thi: " << setw(25) << diemThi->ngayThi << " ║" << endl;
    cout << "╚══════════════════════════════════════════════════════════════════════════════════════╝" << endl;
...
void inBangDiemTheoLop(const string& maLop, const string& maMon) {
    ...
    cout << "╔══════════════════════════════════════════════════════════════════════════════════════╗" << endl;
    cout << "║                        BẢNG ĐIỂM LỚP " << setw(10) << maLop << " - MÔN " << setw(10) << maMon << "                    ║" << endl;
    cout << "╠══════════════════════════════════════════════════════════════════════════════════════╣" << endl;
    cout << "║ STT │ Mã SV │ Họ tên                    │ Điểm │ Ngày thi                      ║" << endl;
    cout << "╠═════╪═══════╪═══════════════════════════╪══════╪═══════════════════════════════╣" << endl;
    ...
    while (sv != nullptr) {
        ...
        if (diemThi != nullptr) {
            cout << "║ " << setw(3) << stt++ << " │ " << setw(5) << sv->maSV << " │ " 
                 ...
                 << setprecision(1) << diemThi->diem << " │ " << setw(29) << diemThi->ngayThi << " ║" << endl;
        }
        sv = sv->tiep;
    }
...
void inBangDiemTongKet(const string& maLop) {
    ...
    cout << "╔══════════════════════════════════════════════════════════════════════════════════════╗" << endl;
    cout << "║                        BẢNG ĐIỂM TỔNG KẾT LỚP " << setw(10) << maLop << "                           ║" << endl;
    cout << "╠══════════════════════════════════════════════════════════════════════════════════════╣" << endl;
    cout << "║ STT │ Mã SV │ Họ tên                    │ Số môn đã thi │ Điểm trung bình   ║" << endl;
    cout << "╠═════╪═══════╪═══════════════════════════╪═══════════════╪═══════════════════╣" << endl;
    ...
    while (sv != nullptr) {
        ...
        cout << "║ " << setw(3) << stt++ << " │ " << setw(5) << sv->maSV << " │ " 
             ...
             << " │ " << setw(17) << fixed << setprecision(2) << diemTrungBinh << " ║" << endl;
...
void thongKeDiemTheoMon(const string& maMon) {
    ...
    cout << "╔══════════════════════════════════════════════════════════════════════════════════════╗" << endl;
    cout << "║                        THỐNG KÊ ĐIỂM MÔN " << setw(15) << maMon << "                             ║" << endl;
    cout << "╠══════════════════════════════════════════════════════════════════════════════════════╣" << endl;
    cout << "║ Tổng số sinh viên thi: " << setw(10) << tongSV << "                                        ║" << endl;
    cout << "║ Số sinh viên đạt (>=5): " << setw(10) << svDat << "                                       ║" << endl;
    cout << "║ Tỷ lệ đạt: " << setw(10) << fixed << setprecision(1) 
         << (tongSV > 0 ? (float)svDat/tongSV*100 : 0) << "%                                              ║" << endl;
    cout << "║ Điểm trung bình: " << setw(10) << fixed << setprecision(2) 
         << (tongSV > 0 ? tongDiem/tongSV : 0) << "                                           ║" << endl;
    cout << "╚══════════════════════════════════════════════════════════════════════════════════════╝" << endl;
}
...
void ghiDiemRaFile(DiemThi* danhSach, const string& tenFile) {
    ...
    while (temp != nullptr) {
        ...
        while (chiTiet != nullptr) {
            file << chiTiet->idCauHoi << "," << chiTiet->dapAnChon << "," << chiTiet->dung << endl;
        ...
        if (pos1 != string::npos && pos2 != string::npos) {
            ...
            while (getline(file, line) && line != "---") {
                ...
                if (pos1 != string::npos && pos2 != string::npos) {
                    ...
                    ChiTietBaiThi* chiTietMoi = taoChiTietBaiThi(idCauHoi, dapAnChon, dung);
